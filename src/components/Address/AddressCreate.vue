...
<template>
  <div class="container mx-auto px-4 py-8 flex-grow max-w-3xl">
    <div class="flex items-start md:px-10 px-0 mb-6 flex-col gap-y-3">
      <RouterLink
    ...
    >
      <div class="p-8">
        <!-- Contact Information -->
        <div class="mb-6 pb-6 border-b border-gray-700" v-for="item in contact" :key="item.id">
          <div class="flex items-center">
            ...
            <div>
              ...
              <p class="text-gray-300 text-sm">{{ item.email }} • {{ item.phone }}</p>
            </div>
          </div>
        </div>
